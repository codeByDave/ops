        ...
        <form method="POST" action="{{ route('customers.service-calls.store', $customer) }}">
          ...
          <div class="row">
            ...
            @if ($hasProfileAddress)
              <div class="col-12 mb-3">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="use_profile_address"
                    id="use_profile_address_no" value="0" checked>
                  <label class="form-check-label" for="use_profile_address_no">No</label>
                </div>

                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="use_profile_address"
                    id="use_profile_address_yes" value="1" data-address1="{{ e($customer->address_1) }}"
                    data-city="{{ e($customer->city) }}" data-state="{{ e($customer->state) }}"
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" class="form-control" id="service_call_city" name="city" value="">
            </div>
